		...
		return this.each(function() {
			...
			if(add_option) {
				$('.'+class_name+' span.add_action').live('click', function() {
					...
					var addquery = '<form class="add_data"><img class="close" src="images/close.png" /><h3>Agregar detalle</h3><textarea></textarea><input type="checkbox" value="" id="hide" /> <label for="hide">Ocultar nodos hijos</label><span class="submit">Enviar</span></form>';
			...
			if(edit_option) {
				$('.'+class_name+' span.edit_action').live('click', function() {
					...
					var editquery = '<form class="edit_data"><img class="close" src="images/close.png" /><h3>Editar Detalles</h3><textarea>'+edit_string.html()+'</textarea><input type="checkbox" '+checked_val+' value="" id="hide" /> <label for="hide">Ocultar nodos hijos</label><span class="edit">Guardar</span></form>';
